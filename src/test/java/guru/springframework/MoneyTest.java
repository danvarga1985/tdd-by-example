...
public class MoneyTest {
    ...
    void testSimpleAddition() {
        ...
        Bank bank = new Bank();
        Money reduced = bank.reduceToSingleMoneyObject(sum, "USD");
    ...
    @Test
    void testReduceSum() {
        Expression sum = new Sum(Money.dollar(3), Money.dollar(2));
        Bank bank = new Bank();
        Money result = bank.reduceToSingleMoneyObject(sum, "USD");
    ...
    void testReduceMoney() {
        Bank bank = new Bank();
        Money result = bank.reduceToSingleMoneyObject(Money.dollar(1), "USD");

        assertEquals(Money.dollar(1), result);
    }

    @Test
    void testReduceMoneyDifferenCurrency() {
        Bank bank = new Bank();
        bank.addRate("CHF", "USD", 2);
        Money result = bank.reduceToSingleMoneyObject(Money.franc(2), "USD");
        assertEquals(Money.dollar(1), result);
    }
    ...
    void testMixedAddition() {
        ...
        Bank bank = new Bank();
        bank.addRate("CHF", "USD", 2);
        Expression result = bank.reduceToSingleMoneyObject(fiveDollars.plus(tenFrancs), "USD");
